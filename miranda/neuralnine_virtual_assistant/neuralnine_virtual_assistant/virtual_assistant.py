...
from custom_intent_methods import CustomIntentMethods
...
class GenericAssistant(IAssistant, CustomIntentMethods):
    ...
    def request(self, message):
        ...
        intent_methods = self.custom_intents()

        # breakpoint()

        # text_response = self._get_response(ints, self.intents)
        ...
        if ints[0]['intent'] in intent_methods.keys():
            ...
            print(f"Predicted intent '{ints[0]['intent']}' with a {ints[0]['probability']} probability.")
